...
const Sectors: React.FC = () => {
  return (
    <div className="py-8">
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-slate-900 mb-3 tracking-tight">Choose Your Track</h1>
        <p className="text-xl text-slate-600 max-w-2xl">
          Select an industry sector to see specialized engineering tracks. Each sector contains projects ranging from entry-level to advanced architecture.
        </p>
      </div>
